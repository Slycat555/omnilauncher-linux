 ...
 * same way AppImageLauncher would, pointed at $APPIMAGE so it keeps working across
 * updates without needing to be reinstalled.
 */
...
`
  ...
  try {
    ...
    // user moved/renamed it, or updated to a new file - stays in sync automatically.
